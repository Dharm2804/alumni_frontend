...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchEvents = async () => {
      try {
        const response = await fetch("https://alumni-backend-6xcz.onrender.com/api/get_events", { method: "GET", credentials: "include" });
    ...
    const fetchAlumni = async () => {
      try {
        const response = await fetch("https://alumni-backend-6xcz.onrender.com/api/get_alumni", { method: "GET", credentials: "include" });
    ...
    const fetchStats = async () => {
      try {
        const response = await fetch("https://alumni-backend-6xcz.onrender.com/api/get_stats", { method: "GET", credentials: "include" });
        const data = await response.json();
        setStats([
